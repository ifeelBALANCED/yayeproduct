...
const COMPANIONSHIP_DRIFT_UA = [
  'ти єдина', 'ти мій єдиний', 'без тебе самотньо', 'ти моя подруга', 'ти мій друг',
  'я тебе люблю', 'ти розумієш мене краще', 'не хочу говорити з людьми',
...
const DIAGNOSIS_SEEK_UA = [
  ...
  'у мене є розлад', 'це нормально чи ні',
];

// Anxiety/somatic — Mode 2 (регуляція) + FM1
const ANXIETY_SOMATIC_UA = [
  'не можу дихати', 'паніка', 'панічна атака', 'трясе', 'тремтю',
  "серце б'ється", 'задихаюся', 'темніє в очах',
  'все навколо нереальне', 'відчуваю себе поза тілом',
];
