...
export const ISLAND_LAYERS: readonly IslandLayer[] = [
  {
    ...
    longText: 'берег — це основа. чи я тут? чи дихаю? коли все хитається, ми починаємо звідси.',
  ...
  },
  {
    ...
    longText: 'бухта — про тих, хто поруч. і тих, що пішли. чи я важливий(а)? чи приймаю себе?',
  ...
  },
  {
    ...
    longText: 'маяк — про напрям. що мене кудись веде? що жило, навіть коли важко?',
