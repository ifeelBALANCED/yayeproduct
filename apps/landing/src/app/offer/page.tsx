      ...
      <div className="mx-auto max-w-2xl px-6 py-12 md:py-16">
        <div className="space-y-5 rounded-3xl border-l-4 border-accent bg-bgSoft px-6 py-8 md:px-8">
          ...
          <p className="font-sans text-base leading-relaxed text-ink">
            Зараз ми працюємо з юристом над юридичним документом публічної
            оферти за українським законодавством. Він буде доступний до
            публічного запуску продукту.
          </p>

          <p className="font-sans text-base leading-relaxed text-ink">
            До оприлюднення оферти доступ до продукту лишається безкоштовним.
            Жодних платних функцій без юридичної рамки.
          </p>
